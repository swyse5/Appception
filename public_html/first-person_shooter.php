            ...
            <?php
               if (2==1) {
                   echo "no games";
                	...
                	echo "<h2>First-Person Shooter Games</h2>";
                   ...
                   $sql = "SELECT * FROM Game WHERE Genre = 'First-person shooter' ORDER BY Name";
         ...
         <section>
            <div id="gameImage">
               <h1><?php
                  ...
                  //create connection
                  $conn = new mysqli($servername, $username, $password, $dbname);
                  $sql = "SELECT * FROM Game WHERE Genre = 'First-person shooter'";
                  $result = $conn->query($sql);
