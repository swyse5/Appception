         ...
         <div class="games">
            <?php
               if (2==1) {
                   ...
                   echo "<h2>Action Role-Playing Games</h2>";
                   ...
                   $sql = "SELECT * FROM Game WHERE Genre = 'Action role-playing' ORDER BY Name";
         ...
         <section>
            <div id="gameImage">
               <h1><?php
                  ...
                  //create connection
                  $conn = new mysqli($servername, $username, $password, $dbname);
                  $sql = "SELECT * FROM Game WHERE Genre = 'Action role-playing'";
                  $result = $conn->query($sql);
